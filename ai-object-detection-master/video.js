...
const objectList = document.getElementById('objectList'); // Added reference to objectList
...
function ai() {
    ...
    objectDetector.detect(c1, (err, results) => {
        ...
        for (let index = 0; index < results.length; index++) {
            ...
            // Display the result in the objectList
            const listItem = document.createElement('li');
            listItem.textContent = `${element.label} - Confidence: ${Math.round(element.confidence * 100)}%`;
